...
export const Dashboard: React.FC<DashboardProps> = ({ userData, onActivate }) => {
  ...
  return (
    ...
    <button 
      ...
      className="bg-gradient-to-r from-red-500 to-rose-600 text-white py-3 rounded-xl font-semibold text-sm shadow-lg shadow-red-900/40 active:scale-95 transition-transform border-t border-white/20"
    >
      Activate
    </button>
    {/* Keep your second button here */}
</div>
            </button>
