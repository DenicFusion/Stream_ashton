  ...
  return (
    <section className="relative py-24 border-y border-white/10 overflow-hidden">
      ...
      <div className="absolute inset-0 z-0">
        <img 
          src="cac.jpg" 
          alt="CAC Certificate Background" 
      ...
      <div className="relative z-10 max-w-4xl mx-auto px-4 text-center">
        <div className="inline-flex items-center justify-center w-16 h-16 rounded-full bg-emerald-500/10 mb-6 border border-emerald-500/20 backdrop-blur-md">
        ...
        <div className="inline-block px-6 py-3 border border-emerald-500/30 rounded-lg bg-emerald-900/30 backdrop-blur-md">
          <span className="text-emerald-400 font-bold tracking-wide uppercase text-sm">The Brand You Can Trust 💎</span>
        </div>
      </div>
    </section>
  );
